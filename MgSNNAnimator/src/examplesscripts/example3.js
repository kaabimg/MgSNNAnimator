...
networkView.drawCurve = true;
networkView.neuronToPlot = 60; //id 

animator.animationDuration = 50;// 50 ms
animator.animationStep = 0.5; // 0.5 ms
animator.refreshInterval = 100; // 100 ms  
